package com.intelligence.androidlibrary.pullableview;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    // 释放刷新的距离
    private float refreshDist = 30;
    // 释放加载的距离
    private float loadmoreDist = 30;
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            ...
            default:
                ...
                refreshStateImageView
                        .setBackgroundResource(R.drawable.ic_pricrity);
                break;
        }
        if (pullDownY > 0) {
            // 刷新结果停留1秒
        ...
        if (loadingView != null) {
            ...
            switch (refreshResult) {
                case SUCCEED:
                    ...
                    loadStateImageView.setBackgroundResource(R.drawable.ic_check);
                    break;
                case FAIL:
                default:
                    // 加载失败
                    ...
                    loadStateImageView.setBackgroundResource(R.drawable.ic_pricrity);
                    break;
            }
